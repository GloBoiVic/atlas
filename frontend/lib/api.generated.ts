...
export interface paths {
  ...
  '/api/v1/paper/broker-state': {
    ...
    /** Broker State */
    get: operations['broker_state_api_v1_paper_broker_state_get'];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
...
export interface components {
  schemas: {
    ...
    PaperBrokerStateResponse: {
      ...
      /** Opentrades */
      openTrades: components['schemas']['PaperBrokerTradeResponse'][];
    };
    /** PaperBrokerTradeResponse */
    PaperBrokerTradeResponse: {
      /** Tradeid */
      tradeId: string;
      /** Instrument */
...
export interface operations {
  ...
  broker_state_api_v1_paper_broker_state_get: {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
